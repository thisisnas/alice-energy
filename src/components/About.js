  ...
  return (
    <>
      ...
      <div className='description'>
        ...
        <p>
          Les études montrent qu’une pompe à chaleur est économique. Son
        ...
        <p>
          Un autre type de question que l’on nous pose concernent l’impact
        ...
        <p>
          Les aides existantes pour financer les travaux d’installation de votre
          pompe à chaleur sont multiples et peuvent selon certains êtres
          complètement couverts. Selon votre profilé vous pouvez en effet
          bénéficier de reductions significatives ! Elles se traduisent par des
          aides ou des reductions d’impôts, en voici certaines :
          <li>
            <strong>MaPrimeRénov'</strong> est une prime s’adressant à tous les
            ménages, elle est calculée en fonction du gain écologique et du
            revenu du ménage.
          </li>
          <li>
            <strong></strong>
            <strong>MaPrimeRénov' sérénité</strong> est une aide fusionnant «
            Habiter mieux sérénité » et de MaPrimeRénov', elle permet aux
            ménages les plus modestes d’avoir une aide et des conseils
            concernant leurs travaux.
          </li>
          <li>
            {' '}
            Si vous rénovez votre logement, certains travaux peuvent bénéficier
            d'une <strong>TVA à taux réduit à 5,5 %</strong>.
          </li>
          <li>
            {' '}
            <strong>Éco-prêt à taux zéro</strong> est un prêt à taux zéro allant
            jusqu’à 50 000€ et concernant les rénovations énergétiques
          </li>
        </p>
      </div>
    </>
